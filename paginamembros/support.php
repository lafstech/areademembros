                            ...
                            ?>
                                <div class="message-wrapper <?php echo $isAdmin ? 'admin' : 'user'; ?>">
                                    <div class="message-icon">
                                        <?php if ($isAdmin): ?>
                                            <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.395c.071-.054.14-.108.21-.162l4.18-4.181a1.146 1.146 0 10-1.62-1.621l-4.181 4.18c-.054.07-.108.14-.162.21m-4.656 5.11a2.64 2.64 0 010-3.732m-5.148 2.082a4.726 4.726 0 000 6.684m16.148-10.452a4.718 4.718 0 00-6.684 0m0 0l-1.33 1.33m6.684-6.684l-1.33-1.33" /></svg>
                                        <?php else: ?>

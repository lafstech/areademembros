...
<head>
    ...
    <style>
        /* === CSS COMPLETO DO ADMIN DASHBOARD (MANTIDO) === */
        :root { --primary-color: #e11d48; --background-color: #111827; --sidebar-color: #1f2937; --glass-background: rgba(31, 41, 55, 0.5); --text-color: #f9fafb; --text-muted: #9ca3af; --border-color: rgba(255, 255, 255, 0.1); --success-color: #22c55e; --error-color: #f87171; --delete-color: #dc2626; }
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .main-content header { margin-bottom: 2.5rem; display: flex; justify-content: space-between; align-items: flex-end; }
        .main-content header h1 { font-size: 2rem; font-weight: 600; }
        .main-content header p { color: var(--text-muted); }
        .btn-new-key { padding: 0.6rem 1rem; background-color: var(--success-color); color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: 600; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; transition: background-color 0.3s; }
        ...
        .action-btns .btn-edit { background-color: var(--primary-color); color: white; padding: 0.5rem 1rem; border-radius: 6px; text-decoration: none; font-size: 0.9rem; }
...
<body>
    ...
    <main class="main-content">
        ...
        <section class="management-card">
            ...
            <form method="POST" action="settings.php">
                ...
                <?php if ($config_edicao['id'] > 0): ?>
                    <a href="settings.php" class="btn-save" style="background-color: #4b5563;">Cancelar Edição</a>
                <?php endif; ?>
            </form>
        </section>
    ...
    <script>
        ...
        document.querySelector('.btn-new-key').addEventListener('click', function(e) {

...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .chart-container { background: var(--glass-background); padding: 2rem; border-radius: 12px; border: 1px solid var(--border-color); }
...
<body>
    ...
    <script>
        // Lógica do menu dropdown do perfil (reutilizada)
